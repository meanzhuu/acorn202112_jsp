		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav me-auto">
				...
				<li class="nav-item"><a
					...
					href="<%=request.getContextPath()%>/cafe/list.jsp">카페</a></li>
				<li class="nav-item"><a
					class="nav-link <%=thisPage.equals("gallery") ? "active" : ""%>"
					href="<%=request.getContextPath()%>/gallery/list.jsp">겔러리</a></li>
			</ul>
			<%
				if (id == null) {
			%>
			...
			<span class="navbar-text me-2"> <a
				...
				로그인중...
			</span> <a class="btn btn-outline-danger btn-sm me-2"
